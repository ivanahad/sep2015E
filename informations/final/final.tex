...
We can see in Fig.2 our class diagram, describing the architecture of our software. We mostly followed the regular architecture offered by Django. The diagram was structu- red by the packages and the ".py" files, for example "players(package).models(.py).User".\\
